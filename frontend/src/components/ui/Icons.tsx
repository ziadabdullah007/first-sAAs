...
export const IconX = mk(<path d="M12 4L4 12M4 4l8 8" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round"/>);
export const IconRefreshCw = mk(<><path d="M2.5 7.5A5.5 5.5 0 0113 5" stroke="currentColor" strokeWidth="1.35" strokeLinecap="round"/><path d="M13.5 8.5A5.5 5.5 0 013 11" stroke="currentColor" strokeWidth="1.35" strokeLinecap="round"/><path d="M13 2v3h-3M3 14v-3h3" stroke="currentColor" strokeWidth="1.35" strokeLinecap="round" strokeLinejoin="round"/></>);
export const IconShieldCheck = mk(<><path d="M8 1.5l5.5 2.5v4c0 3.5-2.5 5.5-5.5 7-3-1.5-5.5-3.5-5.5-7V4L8 1.5z" stroke="currentColor" strokeWidth="1.35" strokeLinejoin="round"/><path d="M5.5 8l2 2 3.5-3.5" stroke="currentColor" strokeWidth="1.35" strokeLinecap="round" strokeLinejoin="round"/></>);
export const IconTrendingUp = mk(<path d="M2 11l4-4 3 3 5-5M10 5h4v4" stroke="currentColor" strokeWidth="1.35" strokeLinecap="round" strokeLinejoin="round"/>);
export const IconTrendingDown = mk(<path d="M2 5l4 4 3-3 5 5M10 11h4V7" stroke="currentColor" strokeWidth="1.35" strokeLinecap="round" strokeLinejoin="round"/>);
export const IconUserPlus = mk(<><circle cx="7" cy="5.5" r="2.5" stroke="currentColor" strokeWidth="1.35"/><path d="M1.5 13.5C1.5 11 4 9 7 9M12 9v4M14 11h-4" stroke="currentColor" strokeWidth="1.35" strokeLinecap="round"/></>);
